...
if __name__ == '__main__':
    ...
    try:
        optlist, args = getopt.getopt(sys.argv[1:], 'd:l:s:p:u:')
    except getopt.error, val:
        optlist, args = (), ()

    debug, port, stream_command, keyfile, certfile, USER = (None,)*6
    ...
    try:
        ...
        if keyfile is not None:
            ...
            M = IMAP4_SSL(host=host, port=port, keyfile=keyfile, certfile=certfile,
                          debug=debug)
        elif stream_command:
